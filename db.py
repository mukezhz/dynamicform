...
from api.model.answer.model import create_answer_table, drop_answer_table
...
def create_table(tablename=None):
    with MySQLManager(hostname, username, password, database) as sql:
        ...
        if not tablename:
            ...
            print("***" * 10)
            if create_answer_table(conn, cur):
                print("Answer table created successfully")
            else:
                print("Answer table already exists or Error has been occurred!")
            print("\n")
...
def drop_table(tablename=None):
    with MySQLManager(hostname, username, password, database) as sql:
        ...
        if not tablename:
            ...
            print("Droping Answer Table")
            print("***" * 10)
            if drop_answer_table(conn, cur):
                print("Answer table deleted successfully")
            else:
                print("Error while droping Answer Table.\nMaybe Table doesn't exists.")
